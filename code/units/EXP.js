exports.code = function(){
    ...
    const mothership = new Discord.RichEmbed()
        ...
        .setTitle('Mothership')
        .setURL('')
        .setAuthor('Lemons', 'https://cdn.discordapp.com/avatars/242687584373964801/4b20eb44bfff0b11f7447ed582fedbb2.png?size=128')
    ...
    const titan = new Discord.RichEmbed()
        ...
        .setTitle('Titan')
        .setURL('')
        .attachFiles(['./resources/titan.png'])
        .setAuthor('Lemons', 'https://cdn.discordapp.com/avatars/242687584373964801/4b20eb44bfff0b11f7447ed582fedbb2.png?size=128')
