            ...
            if (x===3) {
             ...
             if (x===5) {
              ...
              if (x===12) {
               ...
               if (x===30) {
               const attachment = new Attachment('./resources/[p10]Crossing Large mrhidihoEdit (10p)_map.png');
               message.channel.send(attachment);
           
       }
               if (x===31) {
               const attachment = new Attachment('./resources/[p10]Huge Subdivide mrhidihoEdit(10p)_map.pn');
               message.channel.send(attachment);
           
       }
               if (x===32) {
               const attachment = new Attachment('./resources/[p10]Island Warfare (10p)_map.png');
               message.channel.send(attachment);
           
       }
                if (x===33) {
               const attachment = new Attachment('./resources/[p10]Land Mountains (10p)_map.png');
               message.channel.send(attachment);
           
       }
                if (x===34) {
               const attachment = new Attachment('./resources/[p10]Lava Bio-grid mrhidihoEdit (10p)_map.png');
               message.channel.send(attachment);
               ...
               message.channel.send(attachment);
                ...
                if (x===36) {
               const attachment = new Attachment('./resources/[p10]The Final Campaign (10p)_map.png');
               message.channel.send(attachment);
